...
# Список сокетов из предоставленного документа
sockets = [
    "AMD Socket sTR5", "AMD Socket TR4", "FCLGA1851", "AMD Socket AM5", "FCLGA1700",
    "AMD Socket AM4", "FCLGA2066", "AMD Socket SP3r2", "FCLGA1200", "FCBGA1787",
    "AMD Socket FP7", "FCLGA1151", "FCLGA2011", "AMD Socket FP6", "FCBGA1440",
    "AMD Socket AM3+", "AMD Socket FP5", "FCLGA1150", "FCBGA1364", "FCLGA1366",
    "FCLGA1155", "AMD Socket AM3", "BGA1338", "AMD Socket FM2+", "AMD Socket FM1",
    "FCLGA1156", "FCBGA1090", "FCBGA1296", "BGA1493", "AMD Socket AM1",
    "FCBGA1170", "LGA775", "FT1 BGA 413-Ball"
]

# Данные для материнских плат: 5 плат на каждый из 33 сокетов = 165 записей
motherboard_data = [
    # AMD Socket sTR5 (серверные, премиум)
    ("ASRock WRX80 Creator", "AMD Socket sTR5", "DDR5", True, "E-ATX", 599, "USD"),
    ("Gigabyte WRX80 SU8", "AMD Socket sTR5", "DDR5", True, "E-ATX", 650, "USD"),
    ("ASUS Pro WS WRX80E-SAGE", "AMD Socket sTR5", "DDR5", True, "E-ATX", 580, "USD"),
    ("MSI WRX80-A Pro", "AMD Socket sTR5", "DDR5", True, "ATX", 450, "USD"),
    ("Supermicro H13SRD", "AMD Socket sTR5", "DDR5", True, "E-ATX", 700, "USD"),

    # AMD Socket TR4 (премиум для Threadripper)
    ("Gigabyte TRX40 AORUS Pro", "AMD Socket TR4", "DDR4", True, "ATX", 399, "USD"),
    ("ASUS ROG Zenith II Extreme", "AMD Socket TR4", "DDR4", True, "E-ATX", 550, "USD"),
    ("MSI TRX40 PRO 10G", "AMD Socket TR4", "DDR4", True, "ATX", 350, "USD"),
    ("ASRock TRX40 Creator", "AMD Socket TR4", "DDR4", True, "ATX", 450, "USD"),
    ("ASUS Prime TRX40-Pro", "AMD Socket TR4", "DDR4", True, "ATX", 299, "USD"),

    # FCLGA1851 (новый Intel, предположительно)
    ("ASUS Z890 Maximus Hero", "FCLGA1851", "DDR5", True, "ATX", 500, "USD"),
    ("Gigabyte Z890 Aorus Elite", "FCLGA1851", "DDR5", True, "ATX", 400, "USD"),
    ...
    ("ASRock X870E Taichi", "AMD Socket AM5", "DDR5", True, "E-ATX", 450, "USD"),
    ("Gigabyte B650E Aorus Master", "AMD Socket AM5", "DDR5", True, "ATX", 349, "USD"),
    ("MSI MPG X670E Carbon", "AMD Socket AM5", "DDR5", True, "ATX", 400, "USD"),
    ("ASUS ROG Crosshair X670E Hero", "AMD Socket AM5", "DDR5", True, "ATX", 550, "USD"),
    ("ASRock B650M PG Riptide", "AMD Socket AM5", "DDR5", True, "Micro ATX", 250, "USD"),

    # FCLGA1700 (Intel 12th-14th Gen)
    ("ASRock Z790 Taichi Lite", "FCLGA1700", "DDR5", True, "ATX", 350, "USD"),
    ("Gigabyte Z790 Aorus Elite AX", "FCLGA1700", "DDR5", True, "ATX", 300, "USD"),
    ("MSI MAG B760M Mortar", "FCLGA1700", "DDR5", True, "Micro ATX", 190, "USD"),
    ("ASUS PRIME Z690-P", "FCLGA1700", "DDR5", True, "ATX", 250, "USD"),
    ("ASUS ROG Maximus Z790 Apex", "FCLGA1700", "DDR5", True, "E-ATX", 500, "USD"),

    # AMD Socket AM4 (популярный)
    ("ASUS ROG Strix B550-F Gaming", "AMD Socket AM4", "DDR4", True, "ATX", 180, "USD"),
    ("MSI B450 Tomahawk Max", "AMD Socket AM4", "DDR4", True, "ATX", 120, "USD"),
    ("Gigabyte X570 Aorus Elite", "AMD Socket AM4", "DDR4", True, "ATX", 200, "USD"),
    ("ASRock B550 Steel Legend", "AMD Socket AM4", "DDR4", True, "ATX", 150, "USD"),
    ("ASUS ROG Crosshair VIII Hero", "AMD Socket AM4", "DDR4", True, "ATX", 350, "USD"),
    ...
    ("Supermicro H11DSi-NT", "AMD Socket SP3r2", "DDR4", True, "E-ATX", 600, "USD"),
    ("ASRock Rack EPYCD8-2T", "AMD Socket SP3r2", "DDR4", True, "ATX", 450, "USD"),
    ("Gigabyte MZ32-AR0", "AMD Socket SP3r2", "DDR4", True, "E-ATX", 550, "USD"),
    ...
    ("ASUS ZenBook 14", "AMD Socket FP7", "DDR4", True, "Embedded", 200, "USD"),
    ("Lenovo ThinkPad E14", "AMD Socket FP7", "DDR4", True, "Embedded", 250, "USD"),
    ("HP EliteBook 835", "AMD Socket FP7", "DDR4", True, "Embedded", 300, "USD"),
    ("Acer Swift 3", "AMD Socket FP7", "DDR4", True, "Embedded", 180, "USD"),
    ("Dell Latitude 5420", "AMD Socket FP7", "DDR4", True, "Embedded", 350, "USD"),

    # FCLGA1151 (Intel 6th-9th Gen)
    ("ASRock Z390 Taichi", "FCLGA1151", "DDR4", True, "ATX", 200, "USD"),
    ("Gigabyte Z370 AORUS Gaming 3", "FCLGA1151", "DDR4", True, "ATX", 150, "USD"),
    ("MSI Z390-A PRO", "FCLGA1151", "DDR4", True, "ATX", 130, "USD"),
    ("ASUS PRIME H370M-Plus", "FCLGA1151", "DDR4", True, "Micro ATX", 100, "USD"),
    ("ASUS ROG Maximus XI Hero", "FCLGA1151", "DDR4", True, "ATX", 300, "USD"),

    # FCLGA2011 (Intel High-End Desktop/Server)
    ("ASUS ROG Rampage V Extreme", "FCLGA2011", "DDR4", True, "E-ATX", 350, "USD"),
    ...
    ("ASUS ROG Flow X13", "AMD Socket FP6", "DDR4", True, "Embedded", 250, "USD"),
    ("Lenovo Yoga Slim 7", "AMD Socket FP6", "DDR4", True, "Embedded", 300, "USD"),
    ...
    ("Intel NUC 10 Frost Canyon", "FCBGA1440", "DDR4", False, "Mini-ITX", 200, "USD"),
    ("Gigabyte BRIX GB-BXi5", "FCBGA1440", "DDR4", False, "Mini-ITX", 180, "USD"),
    ...
    ("Gigabyte GA-990FXA-UD3", "AMD Socket AM3+", "DDR3", True, "ATX", 120, "USD"),
    ("Biostar TA970XE", "AMD Socket AM3+", "DDR3", False, "ATX", 70, "USD"),

    # AMD Socket FP5 (мобильные, условно)
    ("ASUS TUF Gaming A15", "AMD Socket FP5", "DDR4", True, "Embedded", 200, "USD"),
    ("Lenovo Legion 5", "AMD Socket FP5", "DDR4", True, "Embedded", 250, "USD"),
    ("HP Omen 15", "AMD Socket FP5", "DDR4", True, "Embedded", 300, "USD"),
    ("Acer Predator Helios 300", "AMD Socket FP5", "DDR4", True, "Embedded", 350, "USD"),
    ...
    ("Lenovo ThinkPad T440", "FCBGA1364", "DDR3", False, "Embedded", 180, "USD"),
    ("HP EliteBook 840", "FCBGA1364", "DDR3", False, "Embedded", 200, "USD"),
    ("Dell Latitude E7440", "FCBGA1364", "DDR3", False, "Embedded", 220, "USD"),
    ("Acer TravelMate P645", "FCBGA1364", "DDR3", False, "Embedded", 250, "USD"),
    ...
    ("Gigabyte GA-MA785GM-US2H", "AMD Socket AM3", "DDR2", False, "Micro ATX", 60, "USD"),
    ...
    ("Lenovo Chromebook Flex 5", "BGA1338", "DDR4", False, "Embedded", 180, "USD"),
    ("HP Chromebook x360", "BGA1338", "DDR4", False, "Embedded", 200, "USD"),
    ("Acer Chromebook Spin 713", "BGA1338", "DDR4", False, "Embedded", 250, "USD"),
    ("Dell Chromebook 13", "BGA1338", "DDR4", False, "Embedded", 300, "USD"),

    # AMD Socket FM2+ (старые AMD APU)
    ("ASRock FM2A88X-ITX+", "AMD Socket FM2+", "DDR3", True, "Mini-ITX", 90, "USD"),
    ("MSI A88XM-E45", "AMD Socket FM2+", "DDR3", True, "Micro ATX", 80, "USD"),
    ("Gigabyte GA-F2A88XM-D3H", "AMD Socket FM2+", "DDR3", True, "Micro ATX", 100, "USD"),
    ("ASUS A88XM-A", "AMD Socket FM2+", "DDR3", True, "Micro ATX", 70, "USD"),
    ("Biostar Hi-Fi A88W 3D", "AMD Socket FM2+", "DDR3", True, "ATX", 120, "USD"),

    # AMD Socket FM1 (старые AMD APU)
    ("ASUS F1A55-M LE", "AMD Socket FM1", "DDR3", False, "Micro ATX", 60, "USD"),
    ("Gigabyte GA-A55M-DS2", "AMD Socket FM1", "DDR3", False, "Micro ATX", 70, "USD"),
    ("MSI A55M-P33", "AMD Socket FM1", "DDR3", False, "Micro ATX", 50, "USD"),
    ("ASRock A55M-HVS", "AMD Socket FM1", "DDR3", False, "Micro ATX", 80, "USD"),
    ...
    ("Acer Aspire One D255", "FCBGA1090", "DDR2", False, "Embedded", 90, "USD"),
    ("Lenovo IdeaPad S10-3", "FCBGA1090", "DDR2", False, "Embedded", 100, "USD"),
    ...
    ("ASUS Transformer Book T100", "FCBGA1296", "DDR3", False, "Embedded", 100, "USD"),
    ...
    ("Lenovo Legion Phone Duel", "BGA1493", "DDR5", True, "Embedded", 350, "USD"),
    ...
    ("ASRock AM1H-ITX", "AMD Socket AM1", "DDR3", False, "Mini-ITX", 50, "USD"),
    ("MSI AM1I", "AMD Socket AM1", "DDR3", False, "Mini-ITX", 45, "USD"),
    ("Gigabyte GA-AM1M-S2H", "AMD Socket AM1", "DDR3", False, "Micro ATX", 60, "USD"),
    ...
    ("ASUS VivoTab Note 8", "FCBGA1170", "DDR3", False, "Embedded", 100, "USD"),
    ("Lenovo ThinkPad 8", "FCBGA1170", "DDR3", False, "Embedded", 120, "USD"),
    ("HP Elite x2 1011", "FCBGA1170", "DDR3", False, "Embedded", 140, "USD"),
    ("Acer Aspire Switch 10", "FCBGA1170", "DDR3", False, "Embedded", 160, "USD"),
    ...
    ("ASUS Eee PC X101", "FT1 BGA 413-Ball", "DDR3", False, "Embedded", 50, "USD"),
    ("Acer Aspire One 522", "FT1 BGA 413-Ball", "DDR3", False, "Embedded", 60, "USD"),
    ("Lenovo S205", "FT1 BGA 413-Ball", "DDR3", False, "Embedded", 70, "USD"),
    ("HP dm1z", "FT1 BGA 413-Ball", "DDR3", False, "Embedded", 80, "USD"),
    ("Samsung NC110", "FT1 BGA 413-Ball", "DDR3", False, "Embedded", 90, "USD"),
]
...
# Вставка данных
cursor.executemany('''
    INSERT INTO motherboards (name, socket, memory_type, m2_support, form_factor, price, currency)
    VALUES (?, ?, ?, ?, ?, ?, ?)
''', motherboard_data)
...
print("База данных 'motherboards.db' успешно создана и заполнена с 165 материнскими платами!")